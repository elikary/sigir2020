...
//            if (array[i] != 0) { //ORIGINAL
            if (array[i] != -1.0) { //ROCIO. Change 0 by -1 to allow negative ratings
                this.set(i, array[i]);
            }
        }
...
//            if (data[idx] != 0.0) { //ORIGINAL
            if (data[idx] != -1.0) {    //ROCIO. Change 0 by -1 to allow negative ratings
...
//            if (data[i] != 0.0) { //ORIGINAL
            if (data[i] != -1.0) {  //ROCIO. Change 0 by -1 to allow negative ratings
                res[idx++] = data[i];
            }
        }
...
//            if (ve.get() != 0)//ORIGINAL
            if (ve.get() != -1.0)  //ROCIO. Change 0 by -1 to allow negative ratings
