...
//            if (me.get() != 0) //ORIGINAL
            if (me.get() != -1.0) //ROCIO. Change 0 by -1 to allow negative ratings
                size++;
...
//        if(value != 0.0) { //ORIGINAL
        if(value != -1.0) {  //ROCIO. Change 0 by -1 to allow negative ratings.
            valueSet.add(value);
        }
    }
...
//        if (index >= 0 && rowData[index]!=0.0){ //ORIGINAL
        if (index >= 0 && rowData[index]!=-1.0){ //ROCIO. Change 0 by -1 to allow negative ratings.
            return true;
        } else {
            return false;
        }
...
//                if (val != 0.0) //ORIGINAL
                if (val != -1.0) //ROCIO. Change 0 by -1 to allow negative ratings
                    res.add(col);
            }
            return res;
        } else {
...
//                if (val != 0.0)//ORIGINAL
    ...
    public int rowSize(int row) {
        ...
        int size = 0;
        for (int j = rowPtr[row]; j < rowPtr[row + 1]; j++) {
//            if (rowData[j] != 0.0)//ORIGINAL
                if (rowData[j] != -1.0) //ROCIO. Change 0 by -1 to allow negative ratings
                size++;
        }
...
//                if (val != 0) //ORIGINAL
    ...
    public String toString() {
        ...
        for (MatrixEntry me : this)
//            if (me.get() != 0)//ORIGINAL
                if (me.get() != -1) //ROCIO. Change 0 by -1 to allow negative ratings
